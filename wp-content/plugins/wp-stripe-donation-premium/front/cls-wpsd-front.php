...
class Wpsd_Front {
	...
	use HM_Currency, Wpsd_Common, Wpsd_General_Settings, Wpsd_Form_Settings, Wpsd_Form_Style_Settings, Wpsd_Email_Settings, Wpsd_Donations, Wpsd_Receipt_Email_Temp;
	...
	function wpsd_load_shortcode() {
		...
		if ( wsd_fs()->is_plan__premium_only('pro') ) {
			add_shortcode( 'wpsd_donors', array( $this, 'wpsd_load_donors_panel' ) );
		}
	}
	...
	function wpsd_donation_handler_success() {
		...
		if (
			...
			$this->wpsd_save_donation_info( $wpsdDonationFor, $wpsdName, $wpsdEmail, $wpsdAmount, $wpsdCurrency, $comments, $_POST['address'] );
	...
	function wpsd_save_donation_info( $wpsdDonationFor, $wpsdName, $wpsdEmail, $wpsdAmount, $wpsdCurrency, $comments ) {
