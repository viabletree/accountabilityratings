=== AidWP - Donation and Payment Plugin for Stripe ===
...
AidWP is the WordPress donation plugin that allows you to collect donation or payment on your website via Stripe payment gateway method.

== Description ==

**AidWP** is the **WordPress Donation Plugin** that allows you to collect donation or payment on your WordPress website via Stripe payment gateway method.

What makes this [charity](https://aidwp.com/demo/) plugin powerful is its usability. After installation and some quick settings, donors from around the world can start donating to you via Stripe payment gateway.

= ✅ Accept Donations =

In this WordPress Donation Plugin with some simple steps you can place a Donation form in any page. Donors can use their Credit Card to donate money.

= ✅ Receive Payments =

With this WordPress Payment Plugin you can place a payment form in any page where you want to collect money. Buyers can use their Credit Card to make a payment.
...
* Receipt Email Greeting Message Option
* Receipt Email HTML template Option
