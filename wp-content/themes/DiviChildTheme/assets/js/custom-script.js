...
// 				End
    ...
    // quick rating
    jQuery(document).on('click', '.add-quick-rating',function(){
        if (jQuery(this).hasClass('disabled_btn')) {
            jQuery('.custom-alert-box .alert-primary').text("Sorry you have to login to add ratings");
            jQuery('.custom-alert-box').css('display', "flex").delay(5000).fadeOut();
        }
    ...
    // Donate open close
    jQuery('body #page-container .et_pb_section .et_pb_button_0_tb_header.header_btns , .donate-us-home').on('click',function(){
...
// 	// Home Page Donate Us open 
// 	jQuery('.donate-us-home').on('click',function(){
//         jQuery('.donate-container').css('display', "flex");
//     });
